...
public record ArticleWithCommentsDto(
    ...
    public static ArticleWithCommentsDto of(Long articleId, UserAccountDto userAccountDto, Set<ArticleCommentDto> articleCommentDtos, String title, String content, String hashtag,
